...
namespace Test.Avro
{
    ...
    public partial class ReserveResponse : ISpecificRecord
	{
		public static Schema _SCHEMA = Schema.Parse("{\"type\":\"record\",\"name\":\"ReserveResponse\",\"namespace\":\"test.avro\",\"fields\":[{\"nam" +
				"e\":\"is_reserved\",\"type\":\"boolean\"}]}");
		private bool _is_reserved;
		public virtual Schema Schema
		{
			get
			{
				return ReserveResponse._SCHEMA;
			}
		}
