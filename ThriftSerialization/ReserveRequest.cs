...
public partial class ReserveRequest : TBase
{
  ...
  public ReserveRequest DeepCopy()
  {
    var tmp23 = new ReserveRequest();
    if((Reservation_id != null) && __isset.reservation_id)
    {
      tmp23.Reservation_id = this.Reservation_id;
    }
    tmp23.__isset.reservation_id = this.__isset.reservation_id;
    if((Client_id != null) && __isset.client_id)
    {
      tmp23.Client_id = this.Client_id;
    }
    tmp23.__isset.client_id = this.__isset.client_id;
    return tmp23;
  }
  ...
  {
    if (!(that is ReserveRequest other)) return false;
  ...
  {
    var tmp26 = new StringBuilder("ReserveRequest(");
    int tmp27 = 0;
    if((Reservation_id != null) && __isset.reservation_id)
    {
      if(0 < tmp27++) { tmp26.Append(", "); }
      tmp26.Append("Reservation_id: ");
      Reservation_id.ToString(tmp26);
    }
    if((Client_id != null) && __isset.client_id)
    {
      if(0 < tmp27++) { tmp26.Append(", "); }
      tmp26.Append("Client_id: ");
      Client_id.ToString(tmp26);
    }
    tmp26.Append(')');
