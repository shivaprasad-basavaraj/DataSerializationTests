...
public partial class UnreserveRequest : TBase
{
  ...
  public UnreserveRequest DeepCopy()
  {
    var tmp43 = new UnreserveRequest();
    if((Reservation_id != null) && __isset.reservation_id)
    {
      tmp43.Reservation_id = this.Reservation_id;
    }
    tmp43.__isset.reservation_id = this.__isset.reservation_id;
    if((Client_id != null) && __isset.client_id)
    {
      tmp43.Client_id = this.Client_id;
    }
    tmp43.__isset.client_id = this.__isset.client_id;
    return tmp43;
  }
  ...
  {
    if (!(that is UnreserveRequest other)) return false;
  ...
  {
    var tmp46 = new StringBuilder("UnreserveRequest(");
    int tmp47 = 0;
    if((Reservation_id != null) && __isset.reservation_id)
    {
      if(0 < tmp47++) { tmp46.Append(", "); }
      tmp46.Append("Reservation_id: ");
      Reservation_id.ToString(tmp46);
    }
    if((Client_id != null) && __isset.client_id)
    {
      if(0 < tmp47++) { tmp46.Append(", "); }
      tmp46.Append("Client_id: ");
      Client_id.ToString(tmp46);
    }
    tmp46.Append(')');
